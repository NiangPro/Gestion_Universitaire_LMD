            ...
            <div class="message">
                <div class="d-flex align-items-center">
                    ...
                    <a href="javascript:void()" wire:click='readMessage({{$m->id}})' class="message-content d-flex align-items-center w-100">
                        <div class="message-header w-100 d-flex align-items-center justify-content-between">
                            <div class="sender-info">
                                <span class="text-primary">à {{ $m->receiver->prenom}} {{ $m->receiver->nom}}</span>
                            </div>
                            <div class="message-preview flex-grow-1 px-3 text-center">
